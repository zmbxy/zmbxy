    ...
    <nav ref={scrollRef} id="nav" className="lg:text-sm lg:leading-6 relative">
      ...
      <ul>
        {items?.map(({ name, children }) => (
          <li key={name} className="mt-12 lg:mt-8">
            <h5
            ...
            <ul className="space-y-6 lg:space-y-2 border-l border-slate-100">
              {children?.map(({ name, href }) => (
                <NavItem key={href} href={href}>{name}</NavItem>
              ))}
            </ul>
          </li>
        ))}
        ...
        {/*  </h5>*/}
        {/*  <ul className="space-y-6 lg:space-y-2 border-l border-slate-100">*/}
        {/*    <NavItem href="/html/basic-guide">基本概念</NavItem>*/}
        {/*    <NavItem href="/html/html5-guide">HTML5</NavItem>*/}
        {/*  </ul>*/}
        {/*</li>*/}
        {/*<li className="mt-12 lg:mt-8">*/}
        {/*  <h5*/}
        ...
        {/*  </h5>*/}
        {/*  <ul className="space-y-6 lg:space-y-2 border-l border-slate-100">*/}
        {/*    <NavItem href="/aa">基本概念</NavItem>*/}
        {/*    <NavItem href="/bb">CSS布局模型</NavItem>*/}
        {/*    <NavItem href="/cc">BFC</NavItem>*/}
        {/*    <NavItem href="/dd">几种常见的布局</NavItem>*/}
        {/*    <NavItem href="/ee">CSS预编译</NavItem>*/}
        {/*  </ul>*/}
        {/*</li>*/}
        {/*<li className="mt-12 lg:mt-8">*/}
        {/*  <h5*/}
